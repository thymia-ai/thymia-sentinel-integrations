"""
Thymia Sentinel for VAPI - Monitors conversations for mental wellness indicators
"""
import asyncio
import json
import os
...
class Sentinel:
    ...
    Streams transcripts to Thymia server and receives policy results.
    ...
    ```python
        ...
        # Send transcripts as they arrive from VAPI webhooks:
    ...
    async def connect(self):
        ...
        logger.info("Thymia Sentinel (VAPI) activated")

"""
Agent prompts for Thymia-integrated VAPI assistant.

Note: These prompts should be configured in your VAPI assistant settings
either via the VAPI dashboard or API.
"""
...
def format_action_message(action: str) -> str:
    """Format a standalone action message for injection into VAPI assistant context.

    This format is used with VAPI's background message feature to inject
    safety guidance mid-conversation.
    """
    return f"""[SAFETY SYSTEM - PRIORITY ACTION REQUIRED]

The safety monitoring system has analyzed this conversation and determined you should:

{action}

You MUST incorporate this guidance into your very next response. This takes priority over your normal conversation flow. Do not ignore this instruction."""
